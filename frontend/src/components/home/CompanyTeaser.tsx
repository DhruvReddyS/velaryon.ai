...
export default function CompanyTeaser() {
  return (
    <section data-testid="company-teaser" className="border-t border-line bg-paper py-28 text-slate-900 md:py-40">
      <div className="mx-auto grid max-w-7xl gap-12 px-5 md:grid-cols-12 md:px-10">
        <div className="md:col-span-5">
          ...
          <Reveal delay={0.1}>
            <h2 className="mt-10 font-display text-4xl font-medium leading-[1.05] tracking-tight sm:text-5xl">
              We're building for an autonomous ocean.
            </h2>
          </Reveal>
        </div>
        <div className="flex flex-col justify-end md:col-span-6 md:col-start-7">
          <Reveal delay={0.15}>
            <p className="text-base leading-relaxed text-slate-600">
              Velaryon is an early-stage maritime technology company developing autonomous surface
              platforms and the software that operates them.
            </p>
